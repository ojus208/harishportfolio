  ...
  return (
    <section className="flex justify-between m-auto items-center flex-wrap-reverse gap-10">
        <div className="flex flex-col justify-center items-center md:items-start flex-1">
            <div className="font-montserrat sm:text-[66px] text-4xl font-bold gap-2 flex flex-col items-center md:items-start">
            <h1 className="hidden md:block text-blue-3">Hello,</h1>
            <h1>I'm HARISH <span className="">PANDEY</span>
            </h1>
            <h1 className="text-blue-3"> Website Developer</h1>
            </div>
            <p className="info-text text-sm mt-5 md:text-start text-center">
            My hobby is creating responsive websites using HTML, CSS, Javascript, React and Nextjs. 
            </p>
